...
Посты проверяются в «Мои → Модерация → Импорт». Первое переключение заменяет прежний импорт этого канала готовыми карточками; самостоятельные объявления и настройки сохраняются. Импорт не пишет в канал.
