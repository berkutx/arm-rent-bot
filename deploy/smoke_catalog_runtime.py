...
with TestClient(server.app) as client:
    ...
    print(json.dumps({'packaged_runtime':'passed','district_validation':'passed','travel_persistence':'passed','rental_dates':'passed','description_unchanged':True,'phone_masks':'passed','ban_and_restore':'passed','unique_views':'passed','author_catalog':'passed','unpublished_post_disabled':True,'live_data_accessed':False}))
